...
class ComputationResultView {
    ...
    constructor(textColor: string, backgroundColor: string, resultText: string, optionalInformation: string) {
...
function ResultView(res: ComputationResult): ComputationResultView | undefined {
    switch (res) {
...
export class Transition {
    ...
    constructor(curState: string, readChar: string, newState: string, writeChar: string, tapeMove: string) {
...
export function ComputationDisplayComponent({ curComputationStep, totalComputationSteps, computationResult, curTransition }:
    { curComputationStep: number, totalComputationSteps: number, computationResult: ComputationResult, curTransition: Transition | undefined }) {
