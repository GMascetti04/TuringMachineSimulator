...
//props.curStateName
function StateTransitionsComponent({curStateName,transitionsMap, isTransitionVald, addTransition, deleteTransition, allowEditing} : any) {

    const [viewAddTransitionPopup, changeViewAddTransitionPopup] = useState(false);


    //keep track of a list of TM transitions
    let transitionsArray: {transInput: string, transImage : TransitionImage}[] = [];
    transitionsMap.forEach((value : any,key : any,map : any) => {
